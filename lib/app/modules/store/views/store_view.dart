            ...
            body: NestedScrollView(
              headerSliverBuilder: (context, innerBoxIsScrolled) => [
                SliverAppBar(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        AppSectionHeading(
                          ...
                          onPressed: () => Get.toNamed(Routes.ALL_BRANDS),
                        ),
                        ...
                        AppGridViewLayout(
                          itemCount: 4,
                          mainAxisExtent: 80,
                          itemBuilder: (context, index) => AppBrandsCard(
                  ...
                  bottom: AppTabBar(tabs: categories.map((category) => Tab(child: Text(category.name))).toList()),
                )
              ],
              body: TabBarView(
                  children: categories
                      .map((category) => AppCategoriesTab(
                            category: category,
                          ))
                      .toList()),
            )));
